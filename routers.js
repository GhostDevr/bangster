...
const universeId = '7011673255'; // Replace with your Universe ID
    ...
    try {
        const AuthResponse = await axios.post(
            ...
            querystring.stringify({
                ...
                code,
                redirect_uri: "http://192.168.56.1:5050/api/auth/discord/redirect", // Ajuste conforme necessário
            }),
            {
...
app.get('/api/totalvisits', async (req, res) => {
    try {
        ...
        if (data.data && data.data[0]) {
            ...
            console.log('Total Visits:', totalVisits); // Log total visits

            // Send the visits data back to the frontend
...
app.listen(5050, "192.168.56.1", () => {
    console.log("Server listening in port 192.168.56.1:7777");
});
